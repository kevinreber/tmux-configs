...
`tmux.conf`
```conf
# Instead of the prefix default Ctrl+b, set prefix to be Ctrl+a – Why do this? My Caps Lock button is set to also be Ctrl, so I feel this is more ergonomically comfortable
set -g prefix C-a
